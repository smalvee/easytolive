        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form action="{{ url('property_photo_update') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card card-info">
                                            ...
                                            <button type="submit" class="btn btn-block bg-gradient-warning">Update Property Photo</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card-body -->
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <form action="{{ url('property_info_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                                    ...
                                    <div class="card card-primary card-tabs">
                                        <button class="btn btn-block bg-gradient-primary">Update All Information</button>
                                    </div>
                                </div>
