                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                                ...
                                <div class="text-center mt-5 mb-3">
                                    ...
                                    $wish_list = Wish_list::where('listing_id', $item->id)->get();

                                    ?>

                                    <form action="{{ url('add_wish') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="user_id" value="<?php echo ($t) ?>">
                                        ...
                                        <?php
                                        if ($evaluate == false) { ?>
                                            <button class="btn btn-sm btn-primary">Add to Wish</button>
                                        <?php }
                                        ?>
